...
* 1.1: Redefined next panel/previous panel keybinds. Added forward window to compose state. Script now recognizes the compose window for a forwarded message.
* 1.0: Initial commit
